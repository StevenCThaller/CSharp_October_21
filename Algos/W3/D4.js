...
console.log(fullTree.toArrPreorder().toString() == [25, 15, 10, 4, 12, 22, 18, 24, 50, 35, 31, 44, 35, 70, 66, 90]);
console.log(fullTree.toArrInorder().toString() == [4, 10, 12, 15, 18, 22, 24, 25, 31, 35, 35, 44, 50, 66, 70, 90]);
console.log(fullTree.toArrPostorder().toString() == [4, 12, 10, 18, 24, 22, 15, 31, 35, 44, 35, 66, 90, 70, 50, 25]);
